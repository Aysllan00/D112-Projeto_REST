...
public class OrderRest implements OrderInterface {
	...
	@Override
	@PutMapping("/orders/{orderNumber}/{deliveryPerson}")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void associateOrder(@PathVariable("orderNumber") Integer orderNumber,@PathVariable("deliveryPerson") String deliveryPerson) {
		
		System.out.println("OrderRest - updateOrder " + orderNumber);
		service.associateOrderWithDeliveryPerson(orderNumber, deliveryPerson);
	}
