...
public class OrderClient {
	...
	public void createOrder(Order order) {
        ...
        WebClient.create()
            ...
            .doOnError(error -> {
                System.err.println("Erro ao fazer a requisição: " + error.getMessage());
            })
            .block(); // Espera a resposta sincronamente (para fins de exemplo; use async se preferir)
    }
	 ...
	 */
	public List<Order> getOrdersDelivery() {
		String url = restURL + endpoint;
		System.out.println("URL: " + url);
	...
	public void updateOrder(Order order) {
	    String url = restURL + endpoint + "/" + order.getOrderCode();
	    System.out.println("URL: " + url);
	    ...
	    WebClient.create()
	            ...
	            .retrieve()
	            .toBodilessEntity()
	            .block(); // Espera a conclusão da chamada

	    System.out.println("Sucesso ao atualizar o pedido: " + order.getOrderCode());
	}
